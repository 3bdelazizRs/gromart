...
import 'package:gromart_store/model/ItemAttributes.dart';
...
import 'package:gromart_store/ui/fullScreenImageViewer/FullScreenImageViewer.dart';
...
class _AddOrUpdateProductScreenState extends State<AddOrUpdateProductScreen> {
                          ...
                          children: [
                            ...
                            DropdownSearch<AttributesModel>.multiSelection(
                              ...
                              onChanged: (data) {
                                ...
                                selectedAttributesList.forEach((element) {
                                  itemAttributes!.attributes!.add(Attributes(
                            ...
                            Container(
                                ...
                                child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      print(
                                          "add on lenght ${lstAddOnsTitle.length}");
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  onSaved: (val) {
                                                    setState(() {
                                                      ...
                                                      print(
                                                          "add22 on lenght ${lstAddOnsTitle.length}");
                                                    });
                                                  },
                                                  keyboardType:
                                                      TextInputType.text,
  ...
  submit() async {
    if (veg == false && nonVeg == false) {
      showimgAlertDialog(context, 'Product type is Required!'.tr(),
          'Please Select Veg or Non-Veg'.tr(), true);
          ...
          onPressed: () async {
            ...
            if (singleImage != null) {
              ...
              String image = await FireStoreUtils.uploadUserImageToFireStorage(
                  ...
                  itemAttributes!.variants![index].variantId.toString());
              hideProgress();
