...
import 'package:gromart_store/ui/addOrUpdateProduct/AddOrUpdateProductScreen.dart';
...
class _ManageProductsScreenState extends State<ManageProductsScreen> {
  ...
  void initState() {
    ...
    productsStream = fireStoreUtils
        .getProductsStream(MyAppState.currentUser!.vendorID)
        .asBroadcastStream();
  }
            ...
            StreamBuilder<List<ProductModel>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState ==
                    ConnectionState
                        .waiting) if (fireStoreUtils.isShowLoader == true) {
                } else {
                  return Container(
                    child: Center(
                ...
                if (!snapshot.hasData || (snapshot.data?.isEmpty ?? true)) {
                  return Container(
                    ...
                    child: showEmptyState('No Products'.tr(),
                        'All your products will show up here'.tr()),
                  );
                } else {
                                  ...
                                  SwitchListTile.adaptive(
                                      ...
                                      onChanged: (bool newValue) async {
                                        ...
                                        await fireStoreUtils
                                            .addOrUpdateProduct(productModel);
                          ...
                          Visibility(
                            ...
                            child: Row(
                              children: [
                                Text(
                                  amountShow(
                                      amount: productModel.disPrice.toString()),
                                  style: TextStyle(
                                    fontSize: 18,
                                    fontFamily: "Poppinssm",
                                    fontWeight: FontWeight.bold,
                            ...
                            style: TextStyle(
                                ...
                                decoration:
                                    productModel.disPrice.toString() != "0"
                                        ...
                                        : null,
                                fontFamily: "Poppinssm",
                                color: productModel.disPrice.toString() == "0"
                                    ? Color(COLOR_PRIMARY)
                                    : Colors.grey),
                          ),
                        ],
