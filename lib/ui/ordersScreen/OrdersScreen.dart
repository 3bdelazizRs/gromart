...
import 'package:gromart_store/model/OrderProductModel.dart';
import 'package:gromart_store/model/User.dart';
import 'package:gromart_store/model/VendorModel.dart';
import 'package:gromart_store/model/variant_info.dart';
import 'package:gromart_store/services/FirebaseHelper.dart';
import 'package:gromart_store/services/helper.dart';
import 'package:gromart_store/services/pushnotification.dart';
import 'package:gromart_store/ui/chat_screen/chat_screen.dart';
import 'package:gromart_store/ui/ordersScreen/OrderDetailsScreen.dart';
import 'package:gromart_store/ui/reviewScreen.dart';
...
class _OrdersScreenState extends State<OrdersScreen> {
                    ...
                    Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image:
                                NetworkImage(orderModel.products.first.photo),
                            fit: BoxFit.cover,
                            ...
                            orderModel.takeAway!
                                ...
                                : Row(
                                    ...
                                    children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            '${"Deliver to:".tr()} ${orderModel.address.getFullAddress()}'
                                                .tr(),
                                            maxLines: 3,
                                            style: TextStyle(
                                                color: isDarkMode(context)
                      ...
                      child: Row(
                        children: [
                          ...
                          orderModel.estimatedTimeToPrepare == null
                              ? Text("00:00")
                              : Text(orderModel.estimatedTimeToPrepare
                                      .toString() +
  ...
  Future<void> _displayTextInputDialog(
    ...
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            title: Text('Estimated time to Prepare'.tr()),
            content: Column(
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      enabledBorder: OutlineInputBorder(
                        borderSide:
                            BorderSide(color: Color(COLOR_PRIMARY), width: 0.0),
                      ),
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (estimatedTime.text.isNotEmpty) {
                            ...
                            await FireStoreUtils.sendFcmMessage(
                                restaurantAccepted, orderModel.author.fcmToken);
