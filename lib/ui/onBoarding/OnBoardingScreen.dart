...
class _OnBoardingScreenState extends State<OnBoardingScreen> {
  ...
  final List<String> _subtitlesList = [
    ...
    'Find perfect store nearby or  place order at your favorite store in few clicks.'.tr().tr(),
    'A diverse list of different dining stores throughout the territory and around your area carefully selected'.tr().tr(),
