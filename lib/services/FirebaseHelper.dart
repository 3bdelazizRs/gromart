...
import 'package:gromart_store/constants.dart';
import 'package:gromart_store/main.dart';
import 'package:gromart_store/model/AttributesModel.dart';
import 'package:gromart_store/model/BlockUserModel.dart';
import 'package:gromart_store/model/ChatVideoContainer.dart';
import 'package:gromart_store/model/CurrencyModel.dart';
import 'package:gromart_store/model/DeliveryChargeModel.dart';
import 'package:gromart_store/model/OrderModel.dart';
import 'package:gromart_store/model/ProductModel.dart';
import 'package:gromart_store/model/Ratingmodel.dart';
import 'package:gromart_store/model/ReviewAttributeModel.dart';
import 'package:gromart_store/model/TableModel.dart';
import 'package:gromart_store/model/User.dart';
import 'package:gromart_store/model/VendorModel.dart';
import 'package:gromart_store/model/categoryModel.dart';
import 'package:gromart_store/model/conversation_model.dart';
import 'package:gromart_store/model/email_template_model.dart';
import 'package:gromart_store/model/inbox_model.dart';
import 'package:gromart_store/model/notification_model.dart';
import 'package:gromart_store/model/story_model.dart';
import 'package:gromart_store/model/topupTranHistory.dart';
import 'package:gromart_store/model/withdrawHistoryModel.dart';
import 'package:gromart_store/services/helper.dart';
import 'package:gromart_store/ui/DineIn/BookTableModel.dart';
import 'package:gromart_store/ui/offer/offer_model/offer_model.dart';
import 'package:gromart_store/ui/reauthScreen/reauth_user_screen.dart';
...
class FireStoreUtils {
  ...
  Future<Url> uploadAudioFile(File file, BuildContext context) async {
    ...
    uploadTask.snapshotEvents.listen((event) {
      updateProgress(
          '${"Uploading Audio".tr()} ${(event.bytesTransferred.toDouble() / 1000).toStringAsFixed(2)} /'
...
// or FacebookAuth.i.permissions
  ...
  Future<Url> uploadChatImageToFireStorage(
    ...
    uploadTask.snapshotEvents.listen((event) {
      updateProgress(
          '${"Uploading image".tr()} ${(event.bytesTransferred.toDouble() / 1000).toStringAsFixed(2)} /'
          '${(event.totalBytes.toDouble() / 1000).toStringAsFixed(2)} '
          'KB');
    });
    uploadTask.whenComplete(() {}).catchError((onError) {
